...
public enum MessageCode {
    ...
    CONTACTS_NOT_FOUND(14, HttpStatus.NO_CONTENT, "Contacts not found"),
    USER_REGISTRATION_SUCCESS(15, HttpStatus.CREATED, "user registration success"),
    ...
    USER_NOT_FOUND(18, HttpStatus.NO_CONTENT, "User not found"),
